import os
import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QGraphicsView, QGraphicsScene, QGraphicsPixmapItem, QTabWidget, QPushButton, QVBoxLayout, QHBoxLayout, QWidget, QTextEdit
...
class MultipleViewports(QMainWindow):
    ...
    # MultipleViewports类的其余部分没有改变，保持原样...
